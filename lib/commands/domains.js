...
var domains = function (cmd, _config) {
  ...
  cmd.register(
    ...
    function (domain, record) {
      api.domains.get_record(domain, record, function (err, data) {
        if (err) return print.error(err.message)
        console.log('')
        console.log('[' + data.domain_record.name + ']')
  ...
  cmd.register(
    ...
    function (domain, record_id) {
      api.domains.delete_record(domain, record_id, function (err, data) {
        if (err) return print.error(err.message)
  ...
  cmd.register(
    ...
    function (domain, record_id, name) {
      api.domains.update_record(domain, record_id, function (err, data) {
        if (err) return print.error(err.message)
  ...
  cmd.register(
    ...
    function (domain, type, name, data, priority, port, weight) {
      ...
      api.domains.create_record(domain, type, name, data, priority, port, weight, function (err, data) {
        if (err) return print.error(err.message)
