...
var tools = {
    ...
    */
    ...
    load_config: function () {
        try {
          tools.current_config = JSON.parse(fs.readFileSync(path.normalize(homedir + '/.digio'), 'utf8'))
          return tools.current_config
        } catch (ex) {
            try {
    ...
    get_active_key: function () {
      return tools.current_config.keys[tools.current_config.used]
    },
